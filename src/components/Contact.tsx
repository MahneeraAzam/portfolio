...
function Contact() {
  return (
    <>
      <section id="contact" className="py-40 px-4 md:px-8 bg-[#797d7f]">
        <div className="text-center text-white">
          <h4 className="text-4xl lg:text-5xl font-[Caveat]">
            <span>
              <span className="text-[#4d5656] ">C</span>ontact{' '}
              <span className="text-[#4d5656] ">M</span>e
            </span>
          </h4>
          ...
          <div className="mt-24 flex flex-col lg:flex-row justify-evenly items-start">
            ...
            <div className="flex flex-col justify-center items-start text-center">
              ...
              <div className="flex mb-12 items-start">
                <MdEmail className="text-2xl text-[#4d5656] mr-4" />
                <div className="text-start">
                  <p className="text-white">Have a question?</p>
                  <p className="my-2 text-[#4d5656]">I am here to help you</p>
                  <p className="text-[#4d5656] ">Email me at thomas.david@mail.com</p>
                </div>
              </div>

              <div className="flex mb-12 items-start">
                <MdLocationOn className="text-2xl text-[#4d5656] mr-4" />
                <div className="text-start">
                  <p className="text-white">Current Location</p>
                  <p className="my-2 text-[#4d5656]">Mansoura, Egypt</p>
                  <p className="text-[#4d5656] ">serving clients worldwide</p>
                </div>
              </div>
            ...
            <form className="w-full lg:w-[50%] flex flex-col items-start">
              ...
              <Link href="#home" className="py-3 px-8 rounded-lg text-lg text-white bg-[#4d5656] transition hover:bg-[#909497]  mt-4">
                Send message
              </Link>
            </form>
          </div>
