...
function Portfolio() {
  return (
    <>
      <section id="portfolio" className="w-full py-36 px-8 text-center bg-[#909497]">
        <h4 className={`${caveat.className} text-white text-4xl lg:text-5xl`}>
          <span className="text-[#4d5656]">M</span>y{" "}
          <span className="text-[#4d5656]">L</span>ast{" "}
          <span className="text-[#4d5656]">W</span>ork
        </h4>
