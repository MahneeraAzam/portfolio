...
function Services() {
  return (
    <>
      <section id="services" className="py-40 px-2 md:px-8 bg-[#797d7f]">
        <div className="text-center">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-4 text-start">
            ...
            <div className="rounded-xl py-6 px-4 bg-[#4d5656] flex flex-col justify-between items-center cursor-pointer transition-all duration-[1.2s] hover:bg-[#444]">
